...
<br>
<form name="form1"action="TransferCode.jsp" method="post" target="_blank">
<center>
<div class="wrapper">
<div class="input-data">
            <h3 style="color:blue"><center>TRANSFER AMOUNT FORM</center></h3>
         </div>
         <br><br>
         ...
         <div class="input-data">
            <input type="text" name="taccno"  required>
            <div class="underline"></div>
         ...
         <div class="input-data">
            <input type="text" name="tamt"  required>
            <div class="underline"></div>
